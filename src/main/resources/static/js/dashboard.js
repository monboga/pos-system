document.addEventListener("DOMContentLoaded", function () {
    ...
    const content = document.querySelectorAll('.main-content, .pos-wrapper');
    ...
    function applyInitialSidebarState() {
        ...
        if (savedState === 'collapsed') {
            ...
            // Si el sidebar debe estar contraído al cargar, nos aseguramos de que
            // ningún submenú renderizado por el servidor (con la clase 'show') permanezca visible.
    ...
    function applyInitialTheme() { const savedTheme = localStorage.getItem('theme') || 'light'; htmlElement.setAttribute('data-bs-theme', savedTheme); if (themeSwitch) { themeSwitch.checked = (savedTheme === 'dark'); } }
    if (themeSwitch) { themeSwitch.addEventListener('change', function () { const theme = this.checked ? 'dark' : 'light'; htmlElement.setAttribute('data-bs-theme', theme); localStorage.setItem('theme', theme); }); }
